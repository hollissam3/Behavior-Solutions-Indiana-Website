...
BEGIN
{
  ...
  $postmaster        = 'hollissam3@gmail.com';
  @referers          = qw(behaviorsolutionsindiana.com 192.168.1.3 192.69.182.58 localhost);
  @allow_mail_to     = qw(laura@behaviorsolutionsindiana.com);
  @recipients        = ();
  %recipient_alias   = ();
